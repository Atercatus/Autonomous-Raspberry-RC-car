...
class Camera:
    ...
    def __init__(self):#생성자
        self.left_video_capture = cv2.VideoCapture(0) #1번연결
        self.middle_video_capture = cv2.VideoCapture(1) #2번연결
        self.right_video_capture = cv2.VideoCapture(2) #3번연결
    def get_image(self):
...
print("leftCamera",imageList[0])
print("middleCamera",imageList[1])
print("rightCamera",imageList[2])
cv2.waitKey(0)
